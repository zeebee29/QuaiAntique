 ...
 */
final class Version20230517164331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ouverture_hebdo (id INT AUTO_INCREMENT NOT NULL, jour_semaine VARCHAR(10) NOT NULL, h_ouverture TIME DEFAULT NULL, h_fermeture TIME DEFAULT NULL, plage VARCHAR(10) NOT NULL, plage_txt VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, restaurant_id INT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME DEFAULT NULL, date_reservation DATETIME NOT NULL, nb_convive INT NOT NULL, allergie VARCHAR(255) DEFAULT NULL, midi_soir VARCHAR(10) NOT NULL, INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C84955B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
